...
Run: `probes/bedrock/probe.sh` over `ssm send-command` on `i-0608c819327c72beb`
(command `9321c6da-b83e-4b08-870a-e8e82f22131a`), raw output `probe-run-1.jsonl`.
...
|---|---|---|---|---|---|---|---|
| anthropic.claude-haiku-4-5 | BLOCKED — "Model use case details have not been submitted for this account" | — | — | 1.10 / 5.50 | 1.00 / 5.00 | 1.375 / 0.11 | 1.00 / 5.00 |
